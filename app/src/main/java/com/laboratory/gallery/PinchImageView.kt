...
class PinchImageView : ImageView {
    ...
    override fun canScrollHorizontally(direction: Int): Boolean {
        ...
        val bound: RectF? = getImageBound(null)
        if (bound == null) {
            return false
        }
        if (bound.isEmpty) {
    ...
    private fun dispatchOuterMatrixChanged() {
        ...
        for (listener: OuterMatrixChangedListener in mOuterMatrixChangedListeners!!) {
    ...
    private val isReady: Boolean
        get() = (getDrawable() != null) && (getDrawable().getIntrinsicWidth() > 0) && (getDrawable().getIntrinsicHeight() > 0
    ...
    private fun scrollBy(xDiff: Float, yDiff: Float): Boolean {
        ...
        getImageBound(bound)
        //控件大小
        val displayWidth: Float = getWidth().toFloat()
        val displayHeight: Float = getHeight().toFloat()
     ...
     */
    private inner class ScaleAnimator(start: Matrix, end: Matrix, duration: Long) :
        ValueAnimator(), AnimatorUpdateListener {
        /**
         * 开始矩阵
         */
         ...
         * @param end 结束矩阵
         */
        constructor(start: Matrix, end: Matrix) : this(
            start,
            end,
            SCALE_ANIMATOR_DURATION.toLong()
        ) {
        }
    ...
    object MathUtils {
        ...
        fun getMatrixScale(matrix: Matrix?): FloatArray {
            if (matrix != null) {
                ...
                return floatArrayOf(value.get(0), value.get(4))
            } else {
                return FloatArray(2)
            }
        }
    ...
    companion object {
         ...
         * 图片缩放动画时间
         */
        val SCALE_ANIMATOR_DURATION: Int = 200

        /**
         * 惯性动画衰减参数
         */
        val FLING_DAMPING_FACTOR: Float = 0.9f
        /**
         * 获取图片最大可放大的比例
         *
         * 如果放大大于这个比例则不被允许.
         ...
         * 图片最大放大比例
         */
        protected val maxScale: Float = 4f
        ////////////////////////////////公共状态获取////////////////////////////////
        /**
         * 手势状态：自由状态
         *
